...
date: "2025-11-10"
---
Code created by Aliya Siddiqui from 11/2025-1/2026.
Last update on 1/7/2026
<!--
================================================================================
                          Input File Documentation
================================================================================

This script requires two input files (CSV or XLSX supported):
...
input_file <- readline(prompt = "Enter input filename (e.g., JC_0007.csv or JC_0007.xlsx): ")

# Extract subject ID from filename (remove extension)
subject_id <- sub("\\.(csv|xlsx)$", "", basename(input_file), ignore.case = TRUE)
