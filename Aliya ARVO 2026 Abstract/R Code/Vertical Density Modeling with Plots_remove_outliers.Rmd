...
data_superior_albinism <- read.csv("Superior_albinism.csv") %>%
  filter(Subject != "GS_11902")
data_inferior_albinism <- read.csv("Inferior_albinism.csv") %>%
  filter(Subject != "GS_11902")
data_superior_control <- read.csv("Superior_control.csv") %>%
  filter(Subject != "JC_11597") %>%
  filter(Subject != "JC_11159") %>%
  filter(Subject != "JC_0905")
data_inferior_control <- read.csv("Inferior_control.csv") %>%
  filter(Subject != "JC_11597") %>%
  filter(Subject != "JC_11159") %>%
  filter(Subject != "JC_0905")
```
...
long_df <- data_inferior_albinism %>%
  mutate(
...
master_df_nls <- lapply(split(long_df, long_df$Subject), function(x) {
  ...
  if(!all(is.na(params))) {
    ...
    ggsave(file.path(plots_dir, paste0("fit_plot_", safe_subject, "_inferior", ".png")), gg,
...
# ---- Write results ----
write.csv(master_df_nls, paste0("Albinism_inferior_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)

albinism_inferior_parameters<-master_df_nls
# ---- Summary statistics ----
...
write.csv(summary_stats, paste0("Albinism_inferior_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
...
pAlbinism<-ggplot(parametersAInf, aes(x = Value)) +
  ...
  theme_bw() +
  labs(title = "Density Plots for inferior Albinism Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "albinism_inferior_parameter_densities.png"),
  plot = pAlbinism,
  width = 10,
  height = 8,
  dpi = 300
...
long_df <- data_superior_albinism %>%
  mutate(
    E = E,      # NEW: fitting eccentricity
    D = D         # clean naming
  ) %>%
...
master_df_nls <- lapply(split(long_df, long_df$Subject), function(x) {
  ...
  if(!all(is.na(params))) {
    ...
    safe_subject <- gsub("[^A-Za-z0-9_]", "_", unique(x$Subject))
    ggsave(file.path(plots_dir, paste0("fit_plot_", safe_subject, "_superior", ".png")), gg,
           width = 6, height = 4, dpi = 300)
  }
...
# ---- Write results ----
write.csv(master_df_nls, paste0("Albinism_superior_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)
albinism_superior_parameters<-master_df_nls
# ---- Summary statistics ----
summary_stats <- master_df_nls %>%
  summarise(
    across(c(a, b, c, D0, RMSE, RSS),
...
write.csv(summary_stats, paste0("Albinism_superior_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
albinism_parameters<-master_df_nls
#plot density parameters
...
pAlbinism<-ggplot(parametersASup, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for superior Albinism Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "albinism_superior_parameter_densities.png"),
  plot = pAlbinism,
  width = 10,
  height = 8,
  dpi = 300
...
# Add Region labels
parametersASup$Region <- "Superior"
parametersAInf$Region <- "Inferior"
...
pAlbinismCombined <- ggplot(parametersA, aes(x = Value, fill = Region)) +
  ...
  theme_bw() +
  labs(
    title = "Density Plots for Albinism Parameters (Superior vs Inferior)",
    x = "Value",
    y = "Density"
  ) +
  scale_fill_manual(values = c("Superior" = "skyblue", "Inferior" = "orange"))
...
# ---- Write results ----
write.csv(master_df_nls, paste0("Control_inferior_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)

control_inferior_parameters<-master_df_nls
# ---- Summary statistics ----
summary_stats <- master_df_nls %>%
  summarise(
    across(c(a, b, c, D0, RMSE, RSS),
...
write.csv(summary_stats, paste0("Control_inferior_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
...
pControl<-ggplot(parametersAInf, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for Inferior Control Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "control_inferior_parameter_densities.png"),
  plot = pControl,
  width = 10,
  height = 8,
  dpi = 300
...
# ---- Write results ----
write.csv(master_df_nls, paste0("Control_superior_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)
control_superior_parameters<-master_df_nls
# ---- Summary statistics ----
summary_stats <- master_df_nls %>%
  summarise(
    across(c(a, b, c, D0, RMSE, RSS),
...
write.csv(summary_stats, paste0("Control_superior_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
control_parameters<-master_df_nls
#plot density parameters
...
pControl<-ggplot(parametersASup, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for superior Control Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "control_superior_parameter_densities.png"),
  plot = pControl,
  width = 10,
  height = 8,
  dpi = 300
...
pControlCombined <- ggplot(parametersA, aes(x = Value, fill = Region)) +
  ...
  theme_bw() +
  labs(
    title = "Density Plots for Control Parameters (Superior vs Inferior)",
    x = "Value",
    y = "Density"
  ) +
  scale_fill_manual(values = c("Superior" = "skyblue", "Inferior" = "orange"))
...
## Averaged Superior + Inferior Data Fitting

This section averages the superior and inferior density values together for each subject at each eccentricity, then fits the sigmoid model to the averaged data.

```{r average superior inferior albinism}
# ---- Average Superior and Inferior for Albinism ----

# Add region labels to each dataset
data_superior_albinism_labeled <- data_superior_albinism %>%
  mutate(Region = "Superior")

data_inferior_albinism_labeled <- data_inferior_albinism %>%
  mutate(Region = "Inferior")

# Combine superior and inferior data
combined_albinism <- bind_rows(data_superior_albinism_labeled, data_inferior_albinism_labeled)

# For each subject, find max E where BOTH directions have data, then filter
# Only keep eccentricities where both superior and inferior measurements exist
...
master_df_nls_avg_albinism <- lapply(split(long_df, long_df$Subject), function(x) {
  ...
  if(!all(is.na(params))) {
    ...
    gg <- ggplot(x, aes(E, D)) +
      ...
      theme_minimal(base_size = 14) +
      labs(
        title = paste0("Subject: ", unique(x$Subject), " (Averaged Superior + Inferior)"),
        x = "Eccentricity",
        y = "Density",
        subtitle = paste0(
          "a=", round(params["a"],3), " | ",
    ...
    safe_subject <- gsub("[^A-Za-z0-9_]", "_", unique(x$Subject))
    ggsave(file.path(plots_dir, paste0("fit_plot_", safe_subject, "_averaged_vertical", ".png")), gg,
           width = 6, height = 4, dpi = 300)
  }
...
# ---- Write results ----
write.csv(master_df_nls_avg_albinism, paste0("Albinism_averaged_vertical_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)
...
write.csv(summary_stats_avg_albinism, paste0("Albinism_averaged_vertical_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
...
pAlbinismAvg <- ggplot(parametersAvgAlbinism, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for Averaged (Superior + Inferior) Albinism Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "albinism_averaged_vertical_parameter_densities.png"),
  plot = pAlbinismAvg,
  width = 10,
  height = 8,
  dpi = 300
...
```{r average superior inferior control}
# ---- Average Superior and Inferior for Control ----

# Add region labels to each dataset
data_superior_control_labeled <- data_superior_control %>%
  mutate(Region = "Superior")

data_inferior_control_labeled <- data_inferior_control %>%
  mutate(Region = "Inferior")

# Combine superior and inferior data
combined_control <- bind_rows(data_superior_control_labeled, data_inferior_control_labeled)
...
# ---- Write results ----
write.csv(master_df_nls_avg_control, paste0("Control_averaged_vertical_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)
...
write.csv(summary_stats_avg_control, paste0("Control_averaged_vertical_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
...
pControlAvg <- ggplot(parametersAvgControl, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for Averaged (Superior + Inferior) Control Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "control_averaged_vertical_parameter_densities.png"),
  plot = pControlAvg,
  width = 10,
  height = 8,
  dpi = 300
...
## Wolf Data: Averaged Superior + Inferior Fitting

This section loads the Wolf profile density data, removes subjects ending in "R", averages superior and inferior data, and fits the sigmoid model.

```{r load wolf data}
# ---- Load Wolf Profile Density Data ----
wolf_superior_raw <- read.csv("Superior_profile_density.csv")
wolf_inferior_raw <- read.csv("Inferior_profile_density.csv")

# Rename columns to match the format used elsewhere
wolf_superior_raw <- wolf_superior_raw %>%
  rename(E = Eccentricity_um, D = Density)

wolf_inferior_raw <- wolf_inferior_raw %>%
  rename(E = Eccentricity_um, D = Density)

# ---- Remove subjects ending in "R" ----
wolf_superior <- wolf_superior_raw %>%
  filter(!grepl("R$", Subject))

wolf_inferior <- wolf_inferior_raw %>%
  filter(!grepl("R$", Subject))

# Print how many subjects were removed
cat("Superior - Subjects removed (ending in R):", 
    length(unique(wolf_superior_raw$Subject)) - length(unique(wolf_superior$Subject)), "\n")
cat("Superior - Remaining subjects:", length(unique(wolf_superior$Subject)), "\n")
cat("Inferior - Subjects removed (ending in R):", 
    length(unique(wolf_inferior_raw$Subject)) - length(unique(wolf_inferior$Subject)), "\n")
cat("Inferior - Remaining subjects:", length(unique(wolf_inferior$Subject)), "\n")
```

```{r average wolf superior inferior}
# ---- Average Superior and Inferior for Wolf ----

# Add region labels to each dataset
wolf_superior_labeled <- wolf_superior %>%
  mutate(Region = "Superior")

wolf_inferior_labeled <- wolf_inferior %>%
  mutate(Region = "Inferior")

# Combine superior and inferior data
combined_wolf <- bind_rows(wolf_superior_labeled, wolf_inferior_labeled)
...
# ---- Write results ----
write.csv(master_df_nls_avg_wolf, paste0("Wolf_averaged_vertical_parameter_output_NLS", version_suffix, ".csv"), row.names = FALSE)
...
write.csv(summary_stats_avg_wolf, paste0("Wolf_averaged_vertical_parameter_summary_NLS", version_suffix, ".csv"), row.names = FALSE)
...
pWolfAvg <- ggplot(parametersAvgWolf, aes(x = Value)) +
  ...
  facet_wrap(~ Parameter, scales = "free") +
  theme_bw() +
  labs(title = "Density Plots for Averaged (Superior + Inferior) Wolf Parameters", x = "Value", y = "Density")

ggsave(
  filename = file.path(plots_dir, "wolf_averaged_vertical_parameter_densities.png"),
  plot = pWolfAvg,
  width = 10,
  height = 8,
  dpi = 300
...
write.csv(ttest_albinism_control, paste0("Parameter Summaries/Wilcoxin Test Averaged_Vertical Albinism v Control", version_suffix, ".csv"), row.names = TRUE)
...
write.csv(ttest_wolf_control, paste0("Parameter Summaries/Wilcoxin Test Averaged_Vertical Wolf v Control", version_suffix, ".csv"), row.names = TRUE)
...
datasets_long_avg_all <- bind_rows(
  wolf_averaged_parameters %>% mutate(Dataset = "wolf_averaged_vertical"),
  control_averaged_parameters %>% mutate(Dataset = "control_averaged_vertical"),
  albinism_averaged_parameters %>% mutate(Dataset = "albinism_averaged_vertical")
)
...
combined_violin_avg_all <- ggplot(df_long_avg_all, aes(x = Dataset, y = Value, fill = Dataset)) +
  ...
  scale_fill_manual(values = c("wolf_averaged_vertical" = "#1f77b4", "control_averaged_vertical" = "#ff7f0e", "albinism_averaged_vertical" = "#2ca02c")) +
  theme(legend.position = "none")

ggsave(
  filename = file.path(plots_dir, "violin_all_averaged_vertical_parameters.png"),
...
for (var in vars_to_plot) {
  ...
  ggsave(
    filename = file.path(plots_dir, paste0("violin_all_averaged_vertical_", var, ".png")),
    plot = p_base,
    width = 6, height = 5,
    dpi = 300
  )
  ...
  ggsave(
    filename = file.path(plots_dir, paste0("scaled_violin_all_averaged_vertical_", var, ".png")),
    plot = p_scaled,
    width = 6, height = 5,
    dpi = 300
  )
...
datasets_avg <- list(
  wolf_averaged_vertical    = wolf_averaged_parameters,
  control_averaged_vertical = control_averaged_parameters,
  albinism_averaged_vertical = albinism_averaged_parameters
)
...
### --- Save workbook ---
saveWorkbook(wb_avg, file = paste0("Parameter Summaries/Averaged_Vertical_Decay_Parameter_Summaries", version_suffix, ".xlsx"), overwrite = TRUE)
```
